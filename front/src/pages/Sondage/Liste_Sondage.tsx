...
const ListeSondage = () => {
    ...
    const [deleteSondage] = useDeleteSondageMutation();
    ...
    return (
        <>
            <Breadcrumb pageName="Liste Sondage" />
            <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <div className="max-w-full overflow-x-auto">
                    <Link to="/dashboard/Sondage/Form_Sondage" className="btn btn-primary mb-2 mt-3">Add Sondage</Link>
                    <h2 className="text-center mb-4">Liste Sondage</h2>
                    <input type="search" className="mb-4 p-2 border rounded" placeholder="Rechercher..." />
                    {isLoading ? (
                        <h1>Loading...</h1> // Consider using a spinner here
                    ) : (
                                    ...
                                    <tr key={sondage.id}>
                                        ...
                                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                            <div className="flex items-center space-x-3.5">
                                                <Link to={`/dashboard/Sondage/Form_Sondage/${sondage.id}`} className="hover:text-primary">
                                                    <svg
                                                ...
                                                <button onClick={() => handleDelete(sondage.id)} className="hover:text-primary">
                                                    <svg
                                                        className="fill-current"
                                                        width="18"
                                                        height="18"
