...
import Footer from '../../components/scenes/footer/index.tsx';
...
const Connection = () => {
	...
	const isLogin = useAppSelector((state: { AuthSlice: { isLogin: any; }; }) => state.AuthSlice.isLogin);
	...
	const validationSchema = yup.object().shape({
		email: yup.string().required("Le email d'utilisateur est requis"),
					...
					<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark m-30 ">
						<div className="flex flex-wrap items-center">
							<div className="hidden w-full xl:block xl:w-1/2">
								...
								<div className="py-17.5 px-26 text-center" style={{fontSize:'1.4rem'}}>
									<h1>  AFT RECRUTEMENT</h1>
									<img src={th} alt="th" />
								</div>
							</div>
									...
									<form>
										...
										<div className="mt-6 text-center">
											<p>
												...
												<Link to="/web/compte" className="text-primary">
													crée un compte
												</Link>
											</p>
										</div>
										...
										<div className="mt-6 text-center">
											<p>
												...
												<Link to="/web/forgot_password" className="text-primary">
													Se Connecté
												</Link>
											</p>
										</div>
