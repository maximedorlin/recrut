...
const ListeEvaluation = () => {
    ...
    return (
        <>
            <Breadcrumb pageName="Form Evaluation" />
            <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <div className="max-w-full overflow-x-auto">
                    <Link to="/dashboard/Evaluation/Form_Evaluation" className='btn btn-primary mb-2 mt-3'>Ajouter Évaluation</Link>
                            ...
                            <tbody>
                                {data.map((Evaluation) => (
                                    <tr key={Evaluation.id}>
                                        ...
                                        <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                            <div className="flex Evaluations-center space-x-3.5">
                                                <Link to={`/dashboard/Evaluation/Form_Evaluation/${Evaluation.id}`} className="hover:text-primary">
                                                ...
                                                <button onClick={() => handleDelete(Evaluation.id)} className="hover:text-primary">
                                                    <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18">
