        ...
        <div className="flex flex-col gap-9">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
              <h3 className="font-medium text-black dark:text-white" style={{ fontSize: '1.6rem' }}>Nouvelle offre d'Emploi</h3>
            </div>
              ...
              <div className="p-6.5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4.5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="CDD">Developpeur</option>
                      <option value="CDI">Resource humaine</option>
                      <option value="Freelance">Comptabilité</option>
                    </select>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4.5">
                  <div>
                    ...
                    >
                      <option value="" label="Choisir un type de contrat" />
                      <option value="Python">Developpeur Python</option>
                      <option value="Odoo">Developpeur Odoo</option>
                      <option value="Web">Developpeur Web</option>
                    </select>
                    {formik.touched.typeContrat && formik.errors.typeContrat && (
                      <div className="text-red-500">{formik.errors.typeContrat}</div>
                    )}
                ...
                {/* Champs en ligne (2 sur la même ligne sur grand écran) */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4.5">
                ...
                {/* Champs Date Limite et Type de Contrat */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4.5">
                  {/* Champ Date Limite */}
                  <div>
